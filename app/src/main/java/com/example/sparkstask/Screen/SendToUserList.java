...
import com.example.sparkstask.Adapters.SendToUserAdapter;
import com.example.basicbankingapp.R;
import com.example.sparkstask.Database.TransactionContract.TransactionEntry;
...
public class SendToUserList extends AppCompatActivity implements SendToUserAdapter.OnUserListener {
    ...
    public void onUserClick(int position) {
        ...
        startActivity(new Intent(SendToUserList.this, BottomNavigationActivity.class));
        finish();
    }
    ...
    public void onBackPressed() {
        ...
        title.setText("Do you want to cancel the transaction?");
        title.setGravity(Gravity.CENTER);
        title.setTextSize(16);
        title.setTextColor(getResources().getColor(R.color.mainColor));

        builder_exitButton.setCustomTitle(title).setCancelable(false)
        ...
        alertExit.getWindow().setBackgroundDrawableResource(android.R.color.background_light);
